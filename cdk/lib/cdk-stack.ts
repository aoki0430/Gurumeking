...
export class AwsCdkV2AppStack extends Stack {
	constructor(scope: Construct, id: string, props?: StackProps) {
		...
		new aws_s3_deployment.BucketDeployment(this, "WebsiteDeploy", {
			sources: [
				aws_s3_deployment.Source.data("/index.html", "<html><body><h1>Hello World</h1></body></html>"),
				aws_s3_deployment.Source.data("/error.html", "<html><body><h1>Error!!!!!!!!!!!!!</h1></body></html>"),
...
export default AwsCdkV2AppStack;
